...
const uint16_t hotmk[] PROGMEM =
  { A2, B2, C3, D3, E3, C3, E3, REST, Dx3, B2, Dx3, REST, D3, Ax2, D3, REST, A2, B2, C3, D3, E3, C3, E3, A3, G3, E3, C3, E3, G3 };

const uint8_t hotmkDurations[] PROGMEM =
  { 29, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 500 };

// Funeral March by Chopin
const uint16_t chopinBlock[] PROGMEM =
  { A0, REST, A0, REST, A0, REST, A0, C1, B0, REST, B0, A0, REST, A0, REST, A0, REST, A0 };

const uint8_t chopinBlockDurations[] PROGMEM =
  { 18, 500, 10, 500, 10, 100, 10, 500, 500, 100, 10, 300, 100, 10, 300, 10, 100, 10, 500 };
